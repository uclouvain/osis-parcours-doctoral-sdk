...
[**list_scholarships**](AutocompleteApi.md#list_scholarships) | **GET** /autocomplete/scholarship | 
...
# **list_scholarships**
> InlineResponse2002 list_scholarships()
...
with osis_parcours_doctoral_sdk.ApiClient(configuration) as api_client:
    ...
    # and optional values
    try:
        api_response = api_instance.list_scholarships(limit=limit, offset=offset, search=search, accept_language=accept_language, x_user_first_name=x_user_first_name, x_user_last_name=x_user_last_name, x_user_email=x_user_email, x_user_global_id=x_user_global_id)
        pprint(api_response)
    except osis_parcours_doctoral_sdk.ApiException as e:
