...
class Course(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, type, title, subtitle, organizing_institution, start_date, end_date, hour_volume, authors, is_online, mark, ects, comment, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, type, title, subtitle, organizing_institution, start_date, end_date, hour_volume, authors, is_online, mark, ects, comment, *args, **kwargs):  # noqa: E501
        """Course - a model defined in OpenAPI
