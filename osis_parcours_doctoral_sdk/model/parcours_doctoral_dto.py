...
class ParcoursDoctoralDTO(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, uuid, uuid_admission, reference, statut, intitule_secteur_formation, cree_le, formation, projet, cotutelle, financement, photo_identite_doctorant, matricule_doctorant, noma_doctorant, genre_doctorant, prenom_doctorant, nom_doctorant, commission_proximite, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, uuid, uuid_admission, reference, statut, intitule_secteur_formation, cree_le, formation, projet, cotutelle, financement, photo_identite_doctorant, matricule_doctorant, noma_doctorant, genre_doctorant, prenom_doctorant, nom_doctorant, commission_proximite, *args, **kwargs):  # noqa: E501
        """ParcoursDoctoralDTO - a model defined in OpenAPI
