...
class Seminar(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, type, title, start_date, end_date, country, city, organizing_institution, hour_volume, hour_volume_type, ects, *args, **kwargs):  # noqa: E501
        ...
        self.hour_volume_type = hour_volume_type
        self.ects = ects
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, type, title, start_date, end_date, country, city, organizing_institution, hour_volume, hour_volume_type, ects, *args, **kwargs):  # noqa: E501
        """Seminar - a model defined in OpenAPI
