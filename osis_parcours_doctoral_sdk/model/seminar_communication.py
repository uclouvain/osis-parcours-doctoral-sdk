...
class SeminarCommunication(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, object_type, category, context, title, start_date, is_online, website, authors, comment, parent, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, object_type, category, context, title, start_date, is_online, website, authors, comment, parent, *args, **kwargs):  # noqa: E501
        """SeminarCommunication - a model defined in OpenAPI
